...
import krak.miche.KBot.secondary_Handler.RetrieveFeedbackHandler;
 ...
 * @author Kraktun
 * @version 1.0
 * Class to get all feedbacks from the database
 */

public class RetrieveFeedbackCommand extends BotCommand {

    private static final String LOGTAG = "RETRIEVEFEEDBACKCOMMAND";

    public RetrieveFeedbackCommand() {
        super( "getfeedback", "This command can be used to get feedbacks" );
    }
